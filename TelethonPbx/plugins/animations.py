...
async def _(event):
    ...
    animation_chars = [
        "**Heroku Connecting To Latest [Github Build](Badhacker98/sukhBot)**",
        f"**Build started by user** {Pbx_mention}",
        f"**Deploy** `535a74f0` **by user** **{Pbx_mention}**",
        ...
        "__INFO:🕊️⃝‌ᴘʙx ❤️ᥫ᭡፝֟፝֟†:Logged in as 557667062__",
        "__INFO:🕊️⃝‌ᴘʙx ❤️ᥫ᭡፝֟፝֟†:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
async def _(event):
    ...
    await asyncio.sleep(1.5)
    await event.edit("teri ammy ke jh@nto ko pakad ke building se latka dunga. Chhipkali jaise deewal pe chadh ke tere baap ke muh me moot dunga. Fortune laga ke pelunga teri ammy ke ch00t ko chus jaunga. Vimal khane wale r@ndi ke bachhe m@dharch0d.Mask pehna ke apne l0de ko teri behn ke ch00xt me daal dunga.Paodaan ki shakal ke g@ndu sale. G@nd me sarso ke tail ke sath tezab dal dunga tere jb tu marwane ayega mujhse.Kaali ch00t wali r@nd ke bachhe behnch0d")
    await asyncio.sleep(1.5)
...
@Pbx_cmd(pattern="istar$")
async def ammastar(Pbxstar):
    animation_interval = 2
    animation_ttl = range(0, 11)
    await eor(Pbxstar, "I am A Star")
    animation_chars = [
    ...
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await Pbxstar.edit(animation_chars[i % 11])


@Pbx_cmd(pattern="lmoon$")
...
@Pbx_cmd(pattern="getwell$")
async def getwell(event):
    await eor(event, "🌹🌹🌹🌹🌹🌹🌹🌹 \n🌹😷😢😓😷😢💨🌹\n🌹💝💉🍵💊💐💝🌹\n🌹 GetBetter Soon! 🌹\n🌹🌹🌹🌹🌹🌹🌹🌹")


@Pbx_cmd(pattern="switch$")
async def _(event):
    animation_interval = 0.5
    animation_ttl = range(0, 11)
    await eor(event, "Switch")
    animation_chars = [
        "⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜[🔲](https://github.com/Badhacker98/sukhBot)\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜\n⬜⬜⬜⬜⬜⬜⬜",
...
async def _(event):
    ...
    event = await eor(event, f"**Ready Commando **__{Pbx_mention}....")
    animation_chars = [
        "Ｆｉｉｉｉｉｒｅ",
        f"__**Commando **__{Pbx_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - \n _/﹋\_\n",
        f"__**Commando **__{Pbx_mention}          \n\n_/﹋\_\n (҂`_´)\n  <,︻╦╤─ ҉ - -\n _/﹋\_\n",
        f"__**Commando **__{Pbx_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - - -\n _/﹋\_\n",
        f"__**Commando **__{Pbx_mention}          \n\n_/﹋\_\n (҂`_´)\n<,︻╦╤─ ҉ - -\n _/﹋\_\n",
        f"__**Commando **__{Pbx_mention}          \n\n_/﹋\_\n (҂`_´)\n <,︻╦╤─ ҉ - \n _/﹋\_\n",
...
async def _(event):
    ...
    animation_chars = [
        ...
        f"`Target Selected By Hacker:` {Pbx_mention}",
        ...
        "`Hacking... 100%\n█████████HACKED███████████ `\n\n\n  TERMINAL:\nDownloading Bruteforce-Telegram-0.1.tar.gz (9.3 kB)\nCollecting Data Package\n  Downloading Telegram-Data-Sniffer-7.1.1-py2.py3-none-any.whl (82 kB)\nBuilding wheel for Tg-Bruteforcing (setup.py): finished with status 'done'\nCreated wheel for telegram: filename=Telegram-Data-Sniffer-0.0.1-py3-none-any.whl size=1306 sha256=cb224caad7fe01a6649188c62303cd4697c1869fa12d280570bb6ac6a88e6b7e\n  Stored in directory: /app/.cache/pip/wheels/a2/9f/b5/650dd4d533f0a17ca30cc11120b176643d27e0e1f5c9876b5b\n\n **Successfully Hacked Telegram Server Database**\n\n\n🔹Output: Generating.....",
        f"`Targeted Account Hacked...\n\nPay 999$ To` {Pbx_mention} `To Remove This Hack`\n\n\n  TERMINAL:\nDownloading Bruteforce-Telegram-0.1.tar.gz (9.3 kB)\nCollecting Data Package\n  Downloading Telegram-Data-Sniffer-7.1.1-py2.py3-none-any.whl (82 kB)\nBuilding wheel for Tg-Bruteforcing (setup.py): finished with status 'done'\nCreated wheel for telegram: filename=Telegram-Data-Sniffer-0.0.1-py3-none-any.whl size=1306 sha256=cb224caad7fe01a6649188c62303cd4697c1869fa12d280570bb6ac6a88e6b7e\n  Stored in directory: /app/.cache/pip/wheels/a2/9f/b5/650dd4d533f0a17ca30cc11120b176643d27e0e1f5c9876b5b\n\n **Successfully Hacked Telegram Server Database**\n\n\n🔹**Output:** Successful",
    ]
    for i in animation_ttl:
        await asyncio.sleep(animation_interval)
        await event.edit(animation_chars[i % 12])
